...
_INIT_SH_NOFUN=1
_INIT_SH_NOLOG=1
[ -f "$HOME/.config/zsh/init.sh" ] && source "$HOME/.config/zsh/init.sh"
...
# check login shell
if [[ -o login ]]; then
	[ -f "$HOME/.config/zsh/login.sh" ] && source "$HOME/.config/zsh/login.sh"
...
[ -f "$HOME/.config/zsh/function.sh" ] && . "$HOME/.config/zsh/function.sh"

export PROMPT='%F{118}$(_fish_collapsed_pwd)%f> '
